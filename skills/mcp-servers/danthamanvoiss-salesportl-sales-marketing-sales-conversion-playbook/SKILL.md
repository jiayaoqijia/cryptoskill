---
name: salesportl-sales-marketing-sales-conversion-playbook
description: Build sales and marketing operations qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
version: 2.0.0
tags: [salesportl, sales-marketing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Build sales and marketing operations qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
