---
name: salesportl-real-estate-delivery-operations-planner
description: Design dependable real estate services delivery SOPs with role ownership, QA checkpoints, and feedback loops.
version: 2.0.0
tags: [salesportl, real-estate, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Design dependable real estate services delivery SOPs with role ownership, QA checkpoints, and feedback loops.
