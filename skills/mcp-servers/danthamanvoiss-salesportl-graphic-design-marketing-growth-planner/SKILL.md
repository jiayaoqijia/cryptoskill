---
name: salesportl-graphic-design-marketing-growth-planner
description: Plan measurable graphic design services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable graphic design services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
