---
name: salesportl-ecommerce-marketing-growth-planner
description: Plan measurable ecommerce growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, ecommerce, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable ecommerce growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
