---
name: salesportl-real-estate-skill-handoff-protocol
description: Standardize inter-skill handoffs for real estate services work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, real-estate, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for real estate services work with clear assumptions, approvals, and next-node instructions.
