---
name: salesportl-print-context-intake
description: Collect nuanced print services context across business model, micro-niche, and operating constraints.
version: 2.0.0
tags: [salesportl, print, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Collect nuanced print services context across business model, micro-niche, and operating constraints.
