---
name: salesportl-website-creation-sales-conversion-playbook
description: Build website creation and digital experience qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
version: 2.0.0
tags: [salesportl, website-creation, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Build website creation and digital experience qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
...
## Workflow
1. Define qualification gates and disqualification criteria.
2. Build stage-by-stage messaging for discovery, objection handling, and close.
3. Translate playbook to CRM pipeline stages, SLA timers, and follow-up calendar tasks.
4. Add review loop for conversion leakage with corrective actions by stage.
...
- Objection and close playbook: ...
- Leakage diagnostics + corrective actions: ...
```
