---
name: salesportl-graphic-design-quality-review-orchestrator
description: Run recursive quality checks across graphic design services outputs, scoring logic, consistency, thoroughness, and completeness.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Run recursive quality checks across graphic design services outputs, scoring logic, consistency, thoroughness, and completeness.
