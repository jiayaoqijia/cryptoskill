---
name: salesportl-landscaping-marketing-growth-planner
description: Plan measurable landscaping and lawn care services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, landscaping, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable landscaping and lawn care services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
