---
name: salesportl-website-creation-main-router
description: Route website creation and digital experience tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, website-creation, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route website creation and digital experience tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-website-creation-brand-bootstrap-memory-loop
- salesportl-website-creation-context-intake
- salesportl-website-creation-offer-service-mapper
- salesportl-website-creation-sales-conversion-playbook
- salesportl-website-creation-marketing-growth-planner
- salesportl-website-creation-delivery-operations-planner
- salesportl-website-creation-client-success-expansion
- salesportl-website-creation-skill-handoff-protocol
- salesportl-website-creation-quality-review-orchestrator
