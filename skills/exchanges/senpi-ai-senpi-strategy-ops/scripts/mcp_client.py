...
state. Returns the same unwrapped JSON. JSON-RPC errors and tool-level failures (result.isError)
raise MCPError so callers surface a warning instead of silently reading None.
"""
