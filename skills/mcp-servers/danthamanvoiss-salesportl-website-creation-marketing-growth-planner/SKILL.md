---
name: salesportl-website-creation-marketing-growth-planner
description: Plan measurable website creation and digital experience growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, website-creation, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable website creation and digital experience growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
...
## Workflow
1. Select highest-confidence channels by context, buying cycle, and budget reality.
2. Design campaign roadmap with testing, scaling, and shutdown criteria.
3. Define SalesPortl execution plan: campaign node setup, click-tracking schema, and workflow triggers.
4. Tie campaign outputs to pipeline and revenue checkpoints with weekly optimization loops.
...
- Optimization cadence and scorecard: ...
```
