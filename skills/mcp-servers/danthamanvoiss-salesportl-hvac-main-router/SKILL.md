---
name: salesportl-hvac-main-router
description: Route HVAC home services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, hvac, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route HVAC home services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-hvac-brand-bootstrap-memory-loop
- salesportl-hvac-context-intake
- salesportl-hvac-offer-service-mapper
- salesportl-hvac-sales-conversion-playbook
- salesportl-hvac-marketing-growth-planner
- salesportl-hvac-delivery-operations-planner
- salesportl-hvac-client-success-expansion
- salesportl-hvac-skill-handoff-protocol
- salesportl-hvac-quality-review-orchestrator
