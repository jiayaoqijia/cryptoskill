---
name: salesportl-website-creation-context-intake
description: Collect nuanced website creation and digital experience context across business model, micro-niche, and operating constraints.
version: 2.0.0
tags: [salesportl, website-creation, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Collect nuanced website creation and digital experience context across business model, micro-niche, and operating constraints.
...
## Workflow
1. Collect and normalize business goals, constraints, and current maturity level.
2. Identify micro-niche archetype and operational model from the provided variant list.
3. Capture existing stack usage for campaigns, workflows, pipeline, calendar, and web/app assets.
4. List missing context required for reliable execution and propose smallest follow-up questions.
...
```text
- Context snapshot: ...
- Micro-niche classification: ...
- Knowns/unknowns and risk flags: ...
- Minimal clarifying question set: ...
```
