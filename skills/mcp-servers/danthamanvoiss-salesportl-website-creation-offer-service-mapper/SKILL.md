---
name: salesportl-website-creation-offer-service-mapper
description: Map website creation and digital experience offers/services to ICP demand, operational capacity, and profitability goals.
version: 2.0.0
tags: [salesportl, website-creation, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Map website creation and digital experience offers/services to ICP demand, operational capacity, and profitability goals.
...
## Workflow
1. Map services/products by margin, demand profile, and delivery complexity.
2. Align offers to ICP segments and buying triggers specific to this industry.
3. Define package ladder and cross-sell/upsell pathways.
4. Specify proof requirements and measurable outcomes for each offer.
...
- Offer/service map: ...
- ICP alignment table: ...
- Package ladder recommendations: ...
- Proof and KPI requirements: ...
```
