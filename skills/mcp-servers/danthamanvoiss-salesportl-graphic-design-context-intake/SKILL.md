---
name: salesportl-graphic-design-context-intake
description: Collect nuanced graphic design services context across business model, micro-niche, and operating constraints.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Collect nuanced graphic design services context across business model, micro-niche, and operating constraints.
