---
name: salesportl-restaurants-main-router
description: Route restaurant operations and growth tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, restaurants, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route restaurant operations and growth tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-restaurants-brand-bootstrap-memory-loop
- salesportl-restaurants-context-intake
- salesportl-restaurants-offer-service-mapper
- salesportl-restaurants-sales-conversion-playbook
- salesportl-restaurants-marketing-growth-planner
- salesportl-restaurants-delivery-operations-planner
- salesportl-restaurants-client-success-expansion
- salesportl-restaurants-skill-handoff-protocol
- salesportl-restaurants-quality-review-orchestrator
