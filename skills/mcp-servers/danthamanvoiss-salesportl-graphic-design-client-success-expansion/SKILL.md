---
name: salesportl-graphic-design-client-success-expansion
description: Operationalize retention, expansion, and referral systems for graphic design services with evidence-based account reviews.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Operationalize retention, expansion, and referral systems for graphic design services with evidence-based account reviews.
