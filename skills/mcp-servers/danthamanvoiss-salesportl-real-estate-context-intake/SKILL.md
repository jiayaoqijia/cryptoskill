---
name: salesportl-real-estate-context-intake
description: Collect nuanced real estate services context across business model, micro-niche, and operating constraints.
version: 2.0.0
tags: [salesportl, real-estate, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Collect nuanced real estate services context across business model, micro-niche, and operating constraints.
