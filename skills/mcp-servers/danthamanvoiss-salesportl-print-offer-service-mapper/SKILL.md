---
name: salesportl-print-offer-service-mapper
description: Map print services offers/services to ICP demand, operational capacity, and profitability goals.
version: 2.0.0
tags: [salesportl, print, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Map print services offers/services to ICP demand, operational capacity, and profitability goals.
