...
> `netDeltaRatio`: net delta ratio (string). Returned for **all categories** — it was previously documented as Option-only, that restriction no longer applies. May be an empty string when not applicable.
