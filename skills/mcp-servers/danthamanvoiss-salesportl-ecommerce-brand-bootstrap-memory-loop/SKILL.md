---
name: salesportl-ecommerce-brand-bootstrap-memory-loop
description: Create reusable brand context, SOP memory, and operating guidance for ecommerce accounts starting from zero.
version: 2.0.0
tags: [salesportl, ecommerce, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Create reusable brand context, SOP memory, and operating guidance for ecommerce accounts starting from zero.
