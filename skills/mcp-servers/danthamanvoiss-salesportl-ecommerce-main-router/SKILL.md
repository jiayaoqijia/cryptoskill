---
name: salesportl-ecommerce-main-router
description: Route ecommerce tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, ecommerce, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route ecommerce tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-ecommerce-brand-bootstrap-memory-loop
- salesportl-ecommerce-context-intake
- salesportl-ecommerce-offer-service-mapper
- salesportl-ecommerce-sales-conversion-playbook
- salesportl-ecommerce-marketing-growth-planner
- salesportl-ecommerce-delivery-operations-planner
- salesportl-ecommerce-client-success-expansion
- salesportl-ecommerce-skill-handoff-protocol
- salesportl-ecommerce-quality-review-orchestrator
