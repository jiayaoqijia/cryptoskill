---
name: salesportl-graphic-design-main-router
description: Route graphic design services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route graphic design services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-graphic-design-brand-bootstrap-memory-loop
- salesportl-graphic-design-context-intake
- salesportl-graphic-design-offer-service-mapper
- salesportl-graphic-design-sales-conversion-playbook
- salesportl-graphic-design-marketing-growth-planner
- salesportl-graphic-design-delivery-operations-planner
- salesportl-graphic-design-client-success-expansion
- salesportl-graphic-design-skill-handoff-protocol
- salesportl-graphic-design-quality-review-orchestrator
