---
name: salesportl-ecommerce-client-success-expansion
description: Operationalize retention, expansion, and referral systems for ecommerce with evidence-based account reviews.
version: 2.0.0
tags: [salesportl, ecommerce, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Operationalize retention, expansion, and referral systems for ecommerce with evidence-based account reviews.
