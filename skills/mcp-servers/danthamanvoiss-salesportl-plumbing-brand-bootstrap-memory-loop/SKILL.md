---
name: salesportl-plumbing-brand-bootstrap-memory-loop
description: Create reusable brand context, SOP memory, and operating guidance for plumbing home services accounts starting from zero.
version: 2.0.0
tags: [salesportl, plumbing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Create reusable brand context, SOP memory, and operating guidance for plumbing home services accounts starting from zero.

## Use when
- You are operating inside `SalesPortl-Plumbing-Skills-Suite`.
- You need plumbing home services execution quality for plumbing contractors, dispatch teams, and local service businesses.
...
- new build/remodel plumbing

## Standard operating patterns (SOP)
- urgent lead triage and routing
- quote-to-job conversion
- follow-up for maintenance memberships

## SalesPortl platform tooling focus (if available in workspace)
- campaign triggers for seasonal/local issues
- click tracking by service urgency
- workflow nodes for dispatch and technician handoff
