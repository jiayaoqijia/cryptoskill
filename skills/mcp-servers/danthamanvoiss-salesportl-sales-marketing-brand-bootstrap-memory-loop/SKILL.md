---
name: salesportl-sales-marketing-brand-bootstrap-memory-loop
description: Create reusable brand context, SOP memory, and operating guidance for sales and marketing operations accounts starting from zero.
version: 2.0.0
tags: [salesportl, sales-marketing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Create reusable brand context, SOP memory, and operating guidance for sales and marketing operations accounts starting from zero.
