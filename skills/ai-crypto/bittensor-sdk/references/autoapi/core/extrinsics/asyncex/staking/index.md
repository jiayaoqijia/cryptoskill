# bittensor.core.extrinsics.asyncex.staking &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/asyncex/staking/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/asyncex/staking/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../../_sources/autoapi/bittensor/core/extrinsics/asyncex/staking/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`add_stake_burn_extrinsic()`](<#bittensor.core.extrinsics.asyncex.staking.add_stake_burn_extrinsic>)
    * [`add_stake_extrinsic()`](<#bittensor.core.extrinsics.asyncex.staking.add_stake_extrinsic>)
    * [`add_stake_multiple_extrinsic()`](<#bittensor.core.extrinsics.asyncex.staking.add_stake_multiple_extrinsic>)
    * [`set_auto_stake_extrinsic()`](<#bittensor.core.extrinsics.asyncex.staking.set_auto_stake_extrinsic>)



# bittensor.core.extrinsics.asyncex.staking[#](<#module-bittensor.core.extrinsics.asyncex.staking> "Link to this heading")

## Functions[#](<#functions> "Link to this heading")

[`add_stake_burn_extrinsic`](<#bittensor.core.extrinsics.asyncex.staking.add_stake_burn_extrinsic> "bittensor.core.extrinsics.asyncex.staking.add_stake_burn_extrinsic")(subtensor, wallet, netuid, ...) | Executes a subnet buyback by staking TAO and immediately burning the resulting Alpha.  
---|---  
[`add_stake_extrinsic`](<#bittensor.core.extrinsics.asyncex.staking.add_stake_extrinsic> "bittensor.core.extrinsics.asyncex.staking.add_stake_extrinsic")(subtensor, wallet, netuid, ...[, ...]) | Adds a stake from the specified wallet to the neuron identified by the SS58 address of its hotkey in specified subnet.  
[`add_stake_multiple_extrinsic`](<#bittensor.core.extrinsics.asyncex.staking.add_stake_multiple_extrinsic> "bittensor.core.extrinsics.asyncex.staking.add_stake_multiple_extrinsic")(subtensor, wallet, ...[, ...]) | Adds stake to each `hotkey_ss58` in the list, using each amount, from a common coldkey on subnet with  
[`set_auto_stake_extrinsic`](<#bittensor.core.extrinsics.asyncex.staking.set_auto_stake_extrinsic> "bittensor.core.extrinsics.asyncex.staking.set_auto_stake_extrinsic")(subtensor, wallet, netuid, ...) | Sets the coldkey to automatically stake to the hotkey within specific subnet mechanism.  
  
## Module Contents[#](<#module-contents> "Link to this heading")

async bittensor.core.extrinsics.asyncex.staking.add_stake_burn_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _hotkey_ss58_ , _amount_ , _limit_price =None_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.asyncex.staking.add_stake_burn_extrinsic> "Link to this definition")
...
[ __ previous bittensor.core.extrinsics.asyncex.serving ](<../serving/index.html> "previous page") [ next bittensor.core.extrinsics.asyncex.start_call __](<../start_call/index.html> "next page")
