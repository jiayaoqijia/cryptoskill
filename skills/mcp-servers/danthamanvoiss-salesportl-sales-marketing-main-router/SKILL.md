---
name: salesportl-sales-marketing-main-router
description: Route sales and marketing operations tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, sales-marketing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route sales and marketing operations tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-sales-marketing-brand-bootstrap-memory-loop
- salesportl-sales-marketing-context-intake
- salesportl-sales-marketing-offer-service-mapper
- salesportl-sales-marketing-sales-conversion-playbook
- salesportl-sales-marketing-marketing-growth-planner
- salesportl-sales-marketing-delivery-operations-planner
- salesportl-sales-marketing-client-success-expansion
- salesportl-sales-marketing-skill-handoff-protocol
- salesportl-sales-marketing-quality-review-orchestrator
