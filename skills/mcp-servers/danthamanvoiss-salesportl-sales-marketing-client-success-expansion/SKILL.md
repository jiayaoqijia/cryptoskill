---
name: salesportl-sales-marketing-client-success-expansion
description: Operationalize retention, expansion, and referral systems for sales and marketing operations with evidence-based account reviews.
version: 2.0.0
tags: [salesportl, sales-marketing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Operationalize retention, expansion, and referral systems for sales and marketing operations with evidence-based account reviews.
