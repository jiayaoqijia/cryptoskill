---
name: salesportl-professional-services-skill-handoff-protocol
description: Standardize inter-skill handoffs for professional services work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, professional-services, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for professional services work with clear assumptions, approvals, and next-node instructions.
