---
name: salesportl-graphic-design-skill-handoff-protocol
description: Standardize inter-skill handoffs for graphic design services work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for graphic design services work with clear assumptions, approvals, and next-node instructions.
