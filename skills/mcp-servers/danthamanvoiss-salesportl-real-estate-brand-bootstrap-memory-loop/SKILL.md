---
name: salesportl-real-estate-brand-bootstrap-memory-loop
description: Create reusable brand context, SOP memory, and operating guidance for real estate services accounts starting from zero.
version: 2.0.0
tags: [salesportl, real-estate, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Create reusable brand context, SOP memory, and operating guidance for real estate services accounts starting from zero.
