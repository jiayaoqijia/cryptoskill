# bittensor.core.extrinsics.take &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/take/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/take/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../_sources/autoapi/bittensor/core/extrinsics/take/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`set_take_extrinsic()`](<#bittensor.core.extrinsics.take.set_take_extrinsic>)



# bittensor.core.extrinsics.take[#](<#module-bittensor.core.extrinsics.take> "Link to this heading")

## Functions[#](<#functions> "Link to this heading")

[`set_take_extrinsic`](<#bittensor.core.extrinsics.take.set_take_extrinsic> "bittensor.core.extrinsics.take.set_take_extrinsic")(subtensor, wallet, hotkey_ss58, ...) | Sets the delegate 'take' percentage for a neuron identified by its hotkey.  
---|---  
  
## Module Contents[#](<#module-contents> "Link to this heading")

bittensor.core.extrinsics.take.set_take_extrinsic(_subtensor_ , _wallet_ , _hotkey_ss58_ , _take_ , _action_ , _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.take.set_take_extrinsic> "Link to this definition")
...
[ __ previous bittensor.core.extrinsics.sudo ](<../sudo/index.html> "previous page") [ next bittensor.core.extrinsics.transfer __](<../transfer/index.html> "next page")
