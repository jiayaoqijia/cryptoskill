---
name: salesportl-landscaping-quality-review-orchestrator
description: Run recursive quality checks across landscaping and lawn care services outputs, scoring logic, consistency, thoroughness, and completeness.
version: 2.0.0
tags: [salesportl, landscaping, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Run recursive quality checks across landscaping and lawn care services outputs, scoring logic, consistency, thoroughness, and completeness.
