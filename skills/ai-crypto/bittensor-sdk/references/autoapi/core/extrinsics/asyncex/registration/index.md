# bittensor.core.extrinsics.asyncex.registration &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/asyncex/registration/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/asyncex/registration/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../../_sources/autoapi/bittensor/core/extrinsics/asyncex/registration/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`burned_register_extrinsic()`](<#bittensor.core.extrinsics.asyncex.registration.burned_register_extrinsic>)
    * [`register_limit_extrinsic()`](<#bittensor.core.extrinsics.asyncex.registration.register_limit_extrinsic>)
    * [`register_subnet_extrinsic()`](<#bittensor.core.extrinsics.asyncex.registration.register_subnet_extrinsic>)
    * [`set_subnet_identity_extrinsic()`](<#bittensor.core.extrinsics.asyncex.registration.set_subnet_identity_extrinsic>)



# bittensor.core.extrinsics.asyncex.registration[#](<#module-bittensor.core.extrinsics.asyncex.registration> "Link to this heading")

This module provides async functionalities for registering a wallet with the subtensor network.

## Functions[#](<#functions> "Link to this heading")

[`burned_register_extrinsic`](<#bittensor.core.extrinsics.asyncex.registration.burned_register_extrinsic> "bittensor.core.extrinsics.asyncex.registration.burned_register_extrinsic")(subtensor, wallet, netuid, *) | Registers the wallet to chain by recycling TAO.  
---|---  
[`register_limit_extrinsic`](<#bittensor.core.extrinsics.asyncex.registration.register_limit_extrinsic> "bittensor.core.extrinsics.asyncex.registration.register_limit_extrinsic")(subtensor, wallet, netuid, ...) | Registers the wallet to chain by recycling TAO, with a maximum burn price limit.  
[`register_subnet_extrinsic`](<#bittensor.core.extrinsics.asyncex.registration.register_subnet_extrinsic> "bittensor.core.extrinsics.asyncex.registration.register_subnet_extrinsic")(subtensor, wallet, *[, ...]) | Registers a new subnetwork on the Bittensor blockchain asynchronously.  
[`set_subnet_identity_extrinsic`](<#bittensor.core.extrinsics.asyncex.registration.set_subnet_identity_extrinsic> "bittensor.core.extrinsics.asyncex.registration.set_subnet_identity_extrinsic")(subtensor, wallet, ...) | Set the identity information for a given subnet.  
  
## Module Contents[#](<#module-contents> "Link to this heading")

async bittensor.core.extrinsics.asyncex.registration.burned_register_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.asyncex.registration.burned_register_extrinsic> "Link to this definition")
...
Parameters:
  ...
  * **subtensor** ([_bittensor.core.async_subtensor.AsyncSubtensor_](<../../../async_subtensor/index.html#bittensor.core.async_subtensor.AsyncSubtensor> "bittensor.core.async_subtensor.AsyncSubtensor")) – The subtensor interface to send the extrinsic.
...
Parameters:
  ...
  * **subtensor** ([_bittensor.core.async_subtensor.AsyncSubtensor_](<../../../async_subtensor/index.html#bittensor.core.async_subtensor.AsyncSubtensor> "bittensor.core.async_subtensor.AsyncSubtensor")) – An instance of the Subtensor class to interact with the blockchain.
...
[ __ previous bittensor.core.extrinsics.asyncex.proxy ](<../proxy/index.html> "previous page") [ next bittensor.core.extrinsics.asyncex.root __](<../root/index.html> "next page")
