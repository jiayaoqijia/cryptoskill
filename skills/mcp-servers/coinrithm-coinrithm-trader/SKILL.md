...
| Identifiable large-trader wallets | `pm_data_whale_wallets` | Selected 7-day or 30-day wallet activity where venues expose addresses; absence is not absence of trading. |
