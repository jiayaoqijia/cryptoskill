# bittensor.core.extrinsics.asyncex.transfer &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/asyncex/transfer/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/asyncex/transfer/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../../_sources/autoapi/bittensor/core/extrinsics/asyncex/transfer/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`transfer_extrinsic()`](<#bittensor.core.extrinsics.asyncex.transfer.transfer_extrinsic>)



# bittensor.core.extrinsics.asyncex.transfer[#](<#module-bittensor.core.extrinsics.asyncex.transfer> "Link to this heading")

## Functions[#](<#functions> "Link to this heading")

[`transfer_extrinsic`](<#bittensor.core.extrinsics.asyncex.transfer.transfer_extrinsic> "bittensor.core.extrinsics.asyncex.transfer.transfer_extrinsic")(subtensor, wallet, ...[, ...]) | Transfers funds from this wallet to the destination public key address.  
---|---  
  
## Module Contents[#](<#module-contents> "Link to this heading")

async bittensor.core.extrinsics.asyncex.transfer.transfer_extrinsic(_subtensor_ , _wallet_ , _destination_ss58_ , _amount_ , _keep_alive =True_, _transfer_all =False_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.asyncex.transfer.transfer_extrinsic> "Link to this definition")
...
[ __ previous bittensor.core.extrinsics.asyncex.take ](<../take/index.html> "previous page") [ next bittensor.core.extrinsics.asyncex.unstaking __](<../unstaking/index.html> "next page")
