# bittensor.core.extrinsics.mev_shield &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/mev_shield/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/mev_shield/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../_sources/autoapi/bittensor/core/extrinsics/mev_shield/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`submit_encrypted_extrinsic()`](<#bittensor.core.extrinsics.mev_shield.submit_encrypted_extrinsic>)
    * [`wait_for_extrinsic_by_hash()`](<#bittensor.core.extrinsics.mev_shield.wait_for_extrinsic_by_hash>)



# bittensor.core.extrinsics.mev_shield[#](<#module-bittensor.core.extrinsics.mev_shield> "Link to this heading")

Module provides sync MEV Shield extrinsics.

## Functions[#](<#functions> "Link to this heading")

[`submit_encrypted_extrinsic`](<#bittensor.core.extrinsics.mev_shield.submit_encrypted_extrinsic> "bittensor.core.extrinsics.mev_shield.submit_encrypted_extrinsic")(subtensor, wallet, call[, ...]) | Submits an encrypted extrinsic to the MEV Shield pallet.  
---|---  
[`wait_for_extrinsic_by_hash`](<#bittensor.core.extrinsics.mev_shield.wait_for_extrinsic_by_hash> "bittensor.core.extrinsics.mev_shield.wait_for_extrinsic_by_hash")(subtensor, extrinsic_hash, ...) | Wait for the result of a MeV Shield encrypted extrinsic.  
  
## Module Contents[#](<#module-contents> "Link to this heading")

bittensor.core.extrinsics.mev_shield.submit_encrypted_extrinsic(_subtensor_ , _wallet_ , _call_ , _sign_with ='coldkey'_, _*_ , _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =False_, _wait_for_revealed_execution =True_, _blocks_for_revealed_execution =3_)[#](<#bittensor.core.extrinsics.mev_shield.submit_encrypted_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.mev_shield.wait_for_extrinsic_by_hash(_subtensor_ , _extrinsic_hash_ , _submit_block_hash_ , _timeout_blocks =3_)[#](<#bittensor.core.extrinsics.mev_shield.wait_for_extrinsic_by_hash> "Link to this definition")
...
Parameters:
  ...
  * **subtensor** ([_bittensor.core.subtensor.Subtensor_](<../../subtensor/index.html#bittensor.core.subtensor.Subtensor> "bittensor.core.subtensor.Subtensor")) – SubtensorInterface instance.
...
[ __ previous bittensor.core.extrinsics.liquidity ](<../liquidity/index.html> "previous page") [ next bittensor.core.extrinsics.move_stake __](<../move_stake/index.html> "next page")
