---
name: salesportl-pool-cleaning-sales-conversion-playbook
description: Build pool maintenance services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
version: 2.0.0
tags: [salesportl, pool-cleaning, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Build pool maintenance services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
