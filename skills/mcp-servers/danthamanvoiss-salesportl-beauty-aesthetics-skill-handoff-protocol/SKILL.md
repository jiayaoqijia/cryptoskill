---
name: salesportl-beauty-aesthetics-skill-handoff-protocol
description: Standardize inter-skill handoffs for beauty and aesthetics services work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, beauty-aesthetics, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for beauty and aesthetics services work with clear assumptions, approvals, and next-node instructions.
