---
name: salesportl-plumbing-quality-review-orchestrator
description: Run recursive quality checks across plumbing home services outputs, scoring logic, consistency, thoroughness, and completeness.
version: 2.0.0
tags: [salesportl, plumbing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Run recursive quality checks across plumbing home services outputs, scoring logic, consistency, thoroughness, and completeness.
