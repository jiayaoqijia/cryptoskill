---
name: salesportl-real-estate-quality-review-orchestrator
description: Run recursive quality checks across real estate services outputs, scoring logic, consistency, thoroughness, and completeness.
version: 2.0.0
tags: [salesportl, real-estate, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Run recursive quality checks across real estate services outputs, scoring logic, consistency, thoroughness, and completeness.
