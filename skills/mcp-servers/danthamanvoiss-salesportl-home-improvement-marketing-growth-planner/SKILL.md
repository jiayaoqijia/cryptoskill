---
name: salesportl-home-improvement-marketing-growth-planner
description: Plan measurable home improvement services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, home-improvement, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable home improvement services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
