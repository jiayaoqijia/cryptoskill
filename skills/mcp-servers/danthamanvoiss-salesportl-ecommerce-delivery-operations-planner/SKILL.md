---
name: salesportl-ecommerce-delivery-operations-planner
description: Design dependable ecommerce delivery SOPs with role ownership, QA checkpoints, and feedback loops.
version: 2.0.0
tags: [salesportl, ecommerce, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Design dependable ecommerce delivery SOPs with role ownership, QA checkpoints, and feedback loops.
