---
name: salesportl-graphic-design-sales-conversion-playbook
description: Build graphic design services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
version: 2.0.0
tags: [salesportl, graphic-design, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Build graphic design services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
