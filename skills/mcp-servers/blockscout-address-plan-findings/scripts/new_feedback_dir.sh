...
#
# Create a fresh timestamped findings-feedback directory for an
# implementation plan: <repo>/.ai/impl_plans/<plan-id>/findings-feedback/<timestamp>/.
# Every run gets its own new timestamped directory; nothing existing is
# deleted or touched.
#
...
#
# Usage: new_feedback_dir.sh <plan-id> [impl-plans-dir]
...
report_dir::new "$impl_plans_dir/$plan_id" "findings-feedback"
