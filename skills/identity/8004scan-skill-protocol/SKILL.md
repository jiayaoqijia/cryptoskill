---
name: 8004scan-skill-protocol
description: ERC-8004 protocol knowledge from the 8004scan skill bundle — understand Trustless Agents, Identity/Reputation/Validation registries, agent IDs, registration metadata, feedback, trust models, contract addresses, supported chains, OASF skills/domains, and integration patterns. Use when the user asks about ERC-8004 concepts or agent IDs like "11155111:42" or "8453:17".
version: 1.0.0
tags:
  - erc-8004
  - 8004scan
...
8. **Action request** (register, feedback, search) → Recommend the `8004scan-skill-api` skill for API queries, or guide through the [Agent0 SDK](https://github.com/agent0labs/agent0-ts) for on-chain operations.
...
| Validation | `0x8004Cb1BFb31DAf7788923b405b754f57acEB4272` | `0x8004Cb1BFb31DAf7788923b405b754f57acEB4272` |
...
→ Read `references/agent-schema.md`, list name, description, image, services, registrations, supportedTrusts, x402support.
