# bittensor.core.extrinsics.liquidity &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/liquidity/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/liquidity/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../_sources/autoapi/bittensor/core/extrinsics/liquidity/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`add_liquidity_extrinsic()`](<#bittensor.core.extrinsics.liquidity.add_liquidity_extrinsic>)
    * [`modify_liquidity_extrinsic()`](<#bittensor.core.extrinsics.liquidity.modify_liquidity_extrinsic>)
    * [`remove_liquidity_extrinsic()`](<#bittensor.core.extrinsics.liquidity.remove_liquidity_extrinsic>)
    * [`toggle_user_liquidity_extrinsic()`](<#bittensor.core.extrinsics.liquidity.toggle_user_liquidity_extrinsic>)



# bittensor.core.extrinsics.liquidity[#](<#module-bittensor.core.extrinsics.liquidity> "Link to this heading")

## Functions[#](<#functions> "Link to this heading")

[`add_liquidity_extrinsic`](<#bittensor.core.extrinsics.liquidity.add_liquidity_extrinsic> "bittensor.core.extrinsics.liquidity.add_liquidity_extrinsic")(subtensor, wallet, netuid, ...) | Adds liquidity to the specified price range.  
---|---  
[`modify_liquidity_extrinsic`](<#bittensor.core.extrinsics.liquidity.modify_liquidity_extrinsic> "bittensor.core.extrinsics.liquidity.modify_liquidity_extrinsic")(subtensor, wallet, netuid, ...) | Modifies liquidity in liquidity position by adding or removing liquidity from it.  
[`remove_liquidity_extrinsic`](<#bittensor.core.extrinsics.liquidity.remove_liquidity_extrinsic> "bittensor.core.extrinsics.liquidity.remove_liquidity_extrinsic")(subtensor, wallet, netuid, ...) | Remove liquidity and credit balances back to wallet's hotkey stake.  
[`toggle_user_liquidity_extrinsic`](<#bittensor.core.extrinsics.liquidity.toggle_user_liquidity_extrinsic> "bittensor.core.extrinsics.liquidity.toggle_user_liquidity_extrinsic")(subtensor, wallet, ...) | Allow to toggle user liquidity for specified subnet.  
  
## Module Contents[#](<#module-contents> "Link to this heading")

bittensor.core.extrinsics.liquidity.add_liquidity_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _liquidity_ , _price_low_ , _price_high_ , _hotkey_ss58 =None_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.liquidity.add_liquidity_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.liquidity.modify_liquidity_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _position_id_ , _liquidity_delta_ , _hotkey_ss58 =None_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.liquidity.modify_liquidity_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.liquidity.remove_liquidity_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _position_id_ , _hotkey_ss58 =None_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.liquidity.remove_liquidity_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.liquidity.toggle_user_liquidity_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _enable_ , _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.liquidity.toggle_user_liquidity_extrinsic> "Link to this definition")
...
[ __ previous bittensor.core.extrinsics.crowdloan ](<../crowdloan/index.html> "previous page") [ next bittensor.core.extrinsics.mev_shield __](<../mev_shield/index.html> "next page")
