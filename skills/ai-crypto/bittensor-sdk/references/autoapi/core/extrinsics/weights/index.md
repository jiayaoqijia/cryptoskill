# bittensor.core.extrinsics.weights &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/weights/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/weights/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../_sources/autoapi/bittensor/core/extrinsics/weights/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`commit_timelocked_weights_extrinsic()`](<#bittensor.core.extrinsics.weights.commit_timelocked_weights_extrinsic>)
    * [`commit_weights_extrinsic()`](<#bittensor.core.extrinsics.weights.commit_weights_extrinsic>)
    * [`reveal_weights_extrinsic()`](<#bittensor.core.extrinsics.weights.reveal_weights_extrinsic>)
    * [`set_weights_extrinsic()`](<#bittensor.core.extrinsics.weights.set_weights_extrinsic>)



# bittensor.core.extrinsics.weights[#](<#module-bittensor.core.extrinsics.weights> "Link to this heading")

Module provides sync commit and reveal weights extrinsic.

## Functions[#](<#functions> "Link to this heading")

[`commit_timelocked_weights_extrinsic`](<#bittensor.core.extrinsics.weights.commit_timelocked_weights_extrinsic> "bittensor.core.extrinsics.weights.commit_timelocked_weights_extrinsic")(subtensor, wallet, ...) | Commits the weights for a specific sub subnet mechanism on the Bittensor blockchain using the provided wallet.  
---|---  
[`commit_weights_extrinsic`](<#bittensor.core.extrinsics.weights.commit_weights_extrinsic> "bittensor.core.extrinsics.weights.commit_weights_extrinsic")(subtensor, wallet, netuid, ...) | Commits the weights for a specific sub subnet on the Bittensor blockchain using the provided wallet.  
[`reveal_weights_extrinsic`](<#bittensor.core.extrinsics.weights.reveal_weights_extrinsic> "bittensor.core.extrinsics.weights.reveal_weights_extrinsic")(subtensor, wallet, netuid, ...) | Reveals the weights for a specific sub subnet on the Bittensor blockchain using the provided wallet.  
[`set_weights_extrinsic`](<#bittensor.core.extrinsics.weights.set_weights_extrinsic> "bittensor.core.extrinsics.weights.set_weights_extrinsic")(subtensor, wallet, netuid, ...) | Sets the passed weights in the chain for hotkeys in the sub-subnet of the passed subnet.  
  
## Module Contents[#](<#module-contents> "Link to this heading")

bittensor.core.extrinsics.weights.commit_timelocked_weights_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _mechid_ , _uids_ , _weights_ , _block_time_ , _commit_reveal_version =4_, _version_key =version_as_int_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.weights.commit_timelocked_weights_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.weights.commit_weights_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _mechid_ , _uids_ , _weights_ , _salt_ , _version_key =version_as_int_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.weights.commit_weights_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.weights.set_weights_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _mechid_ , _uids_ , _weights_ , _version_key_ , _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.weights.set_weights_extrinsic> "Link to this definition")
...
[ __ previous bittensor.core.extrinsics.utils ](<../utils/index.html> "previous page") [ next bittensor.core.metagraph __](<../../metagraph/index.html> "next page")
