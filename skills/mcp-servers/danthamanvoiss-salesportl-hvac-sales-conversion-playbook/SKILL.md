---
name: salesportl-hvac-sales-conversion-playbook
description: Build HVAC home services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
version: 2.0.0
tags: [salesportl, hvac, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Build HVAC home services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
