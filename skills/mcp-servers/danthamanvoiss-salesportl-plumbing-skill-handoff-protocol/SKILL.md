---
name: salesportl-plumbing-skill-handoff-protocol
description: Standardize inter-skill handoffs for plumbing home services work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, plumbing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for plumbing home services work with clear assumptions, approvals, and next-node instructions.
