---
name: salesportl-hvac-brand-bootstrap-memory-loop
description: Create reusable brand context, SOP memory, and operating guidance for HVAC home services accounts starting from zero.
version: 2.0.0
tags: [salesportl, hvac, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Create reusable brand context, SOP memory, and operating guidance for HVAC home services accounts starting from zero.

## Use when
- You are operating inside `SalesPortl-HVAC-Skills-Suite`.
- You need HVAC home services execution quality for HVAC contractors, service teams, and home-service operators.
...
- installation/replacement specialists

## Standard operating patterns (SOP)
- call triage and dispatch priority
- estimate→approval→install workflow
- maintenance-plan renewal cadence

## SalesPortl platform tooling focus (if available in workspace)
- campaign nodes for seasonal demand
- click tracking by emergency vs install intent
- pipeline/dispatch calendar automation
