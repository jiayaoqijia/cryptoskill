---
name: salesportl-website-creation-skill-handoff-protocol
description: Standardize inter-skill handoffs for website creation and digital experience work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, website-creation, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for website creation and digital experience work with clear assumptions, approvals, and next-node instructions.
