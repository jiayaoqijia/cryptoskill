---
name: salesportl-print-marketing-growth-planner
description: Plan measurable print services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, print, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable print services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
