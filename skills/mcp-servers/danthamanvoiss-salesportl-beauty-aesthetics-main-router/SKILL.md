---
name: salesportl-beauty-aesthetics-main-router
description: Route beauty and aesthetics services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, beauty-aesthetics, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route beauty and aesthetics services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-beauty-aesthetics-brand-bootstrap-memory-loop
- salesportl-beauty-aesthetics-context-intake
- salesportl-beauty-aesthetics-offer-service-mapper
- salesportl-beauty-aesthetics-sales-conversion-playbook
- salesportl-beauty-aesthetics-marketing-growth-planner
- salesportl-beauty-aesthetics-delivery-operations-planner
- salesportl-beauty-aesthetics-client-success-expansion
- salesportl-beauty-aesthetics-skill-handoff-protocol
- salesportl-beauty-aesthetics-quality-review-orchestrator
