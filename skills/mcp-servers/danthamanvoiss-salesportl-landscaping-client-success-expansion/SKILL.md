---
name: salesportl-landscaping-client-success-expansion
description: Operationalize retention, expansion, and referral systems for landscaping and lawn care services with evidence-based account reviews.
version: 2.0.0
tags: [salesportl, landscaping, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Operationalize retention, expansion, and referral systems for landscaping and lawn care services with evidence-based account reviews.
