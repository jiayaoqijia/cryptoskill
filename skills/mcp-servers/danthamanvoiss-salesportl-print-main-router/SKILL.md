---
name: salesportl-print-main-router
description: Route print services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, print, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route print services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.

## Use when
- You are operating inside `SalesPortl-Print-Skills-Suite`.
- You need print services execution quality for print design studios, production teams, and local print shops.
...
- B2B commercial print
- events/signage print
- direct-mail print

## Standard operating patterns (SOP)
- preflight and proofing
- bleed/trim/color profile control
- job ticketing and production handoff

## SalesPortl platform tooling focus (if available in workspace)
- campaign send prep for direct-mail follow-up
- click/QR tracking setup for printed assets
- pipeline stage automation for quote→proof→production
...
- salesportl-print-brand-bootstrap-memory-loop
- salesportl-print-context-intake
- salesportl-print-offer-service-mapper
- salesportl-print-sales-conversion-playbook
- salesportl-print-marketing-growth-planner
- salesportl-print-delivery-operations-planner
- salesportl-print-client-success-expansion
- salesportl-print-skill-handoff-protocol
- salesportl-print-quality-review-orchestrator
