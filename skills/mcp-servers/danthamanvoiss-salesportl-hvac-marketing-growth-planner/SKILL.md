---
name: salesportl-hvac-marketing-growth-planner
description: Plan measurable HVAC home services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, hvac, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable HVAC home services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
