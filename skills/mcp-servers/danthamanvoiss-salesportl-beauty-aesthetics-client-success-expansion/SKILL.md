---
name: salesportl-beauty-aesthetics-client-success-expansion
description: Operationalize retention, expansion, and referral systems for beauty and aesthetics services with evidence-based account reviews.
version: 2.0.0
tags: [salesportl, beauty-aesthetics, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Operationalize retention, expansion, and referral systems for beauty and aesthetics services with evidence-based account reviews.
...
## Workflow
1. Set onboarding, adoption, and value-realization checkpoints.
2. Define health-score signals and churn-risk triggers.
3. Build expansion/referral moments grounded in verified outcomes.
4. Attach recurring review workflows and memory updates for account-level improvement.
...
## Output format
```text
- Onboarding and adoption flow: ...
- Health score model: ...
- Expansion/referral trigger map: ...
- Review cadence with memory updates: ...
```
