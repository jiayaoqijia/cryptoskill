---
name: salesportl-pool-cleaning-context-intake
description: Collect nuanced pool maintenance services context across business model, micro-niche, and operating constraints.
version: 2.0.0
tags: [salesportl, pool-cleaning, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Collect nuanced pool maintenance services context across business model, micro-niche, and operating constraints.
