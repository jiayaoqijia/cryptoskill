---
name: salesportl-painting-sales-conversion-playbook
description: Build painting services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
version: 2.0.0
tags: [salesportl, painting, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Build painting services qualification, objection-handling, and close workflows aligned to pipeline and calendar operations.
