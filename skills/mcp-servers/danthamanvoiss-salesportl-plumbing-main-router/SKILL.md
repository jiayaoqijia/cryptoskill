---
name: salesportl-plumbing-main-router
description: Route plumbing home services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, plumbing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route plumbing home services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
...
- salesportl-plumbing-brand-bootstrap-memory-loop
- salesportl-plumbing-context-intake
- salesportl-plumbing-offer-service-mapper
- salesportl-plumbing-sales-conversion-playbook
- salesportl-plumbing-marketing-growth-planner
- salesportl-plumbing-delivery-operations-planner
- salesportl-plumbing-client-success-expansion
- salesportl-plumbing-skill-handoff-protocol
- salesportl-plumbing-quality-review-orchestrator
