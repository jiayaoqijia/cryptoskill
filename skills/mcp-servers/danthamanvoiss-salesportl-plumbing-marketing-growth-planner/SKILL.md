---
name: salesportl-plumbing-marketing-growth-planner
description: Plan measurable plumbing home services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, plumbing, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable plumbing home services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
