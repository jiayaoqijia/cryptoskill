# bittensor.core.extrinsics.move_stake &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/move_stake/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/move_stake/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../_sources/autoapi/bittensor/core/extrinsics/move_stake/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`move_stake_extrinsic()`](<#bittensor.core.extrinsics.move_stake.move_stake_extrinsic>)
    * [`swap_stake_extrinsic()`](<#bittensor.core.extrinsics.move_stake.swap_stake_extrinsic>)
    * [`transfer_stake_extrinsic()`](<#bittensor.core.extrinsics.move_stake.transfer_stake_extrinsic>)



# bittensor.core.extrinsics.move_stake[#](<#module-bittensor.core.extrinsics.move_stake> "Link to this heading")

## Functions[#](<#functions> "Link to this heading")

[`move_stake_extrinsic`](<#bittensor.core.extrinsics.move_stake.move_stake_extrinsic> "bittensor.core.extrinsics.move_stake.move_stake_extrinsic")(subtensor, wallet, origin_netuid, ...) | Moves stake to a different hotkey and/or subnet while keeping the same coldkey owner.  
---|---  
[`swap_stake_extrinsic`](<#bittensor.core.extrinsics.move_stake.swap_stake_extrinsic> "bittensor.core.extrinsics.move_stake.swap_stake_extrinsic")(subtensor, wallet, hotkey_ss58, ...) | Moves stake between subnets while keeping the same coldkey-hotkey pair ownership.  
[`transfer_stake_extrinsic`](<#bittensor.core.extrinsics.move_stake.transfer_stake_extrinsic> "bittensor.core.extrinsics.move_stake.transfer_stake_extrinsic")(subtensor, wallet, ...[, ...]) | Transfers stake from one subnet to another while changing the coldkey owner.  
  
## Module Contents[#](<#module-contents> "Link to this heading")

bittensor.core.extrinsics.move_stake.move_stake_extrinsic(_subtensor_ , _wallet_ , _origin_netuid_ , _origin_hotkey_ss58_ , _destination_netuid_ , _destination_hotkey_ss58_ , _amount =None_, _move_all_stake =False_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.move_stake.move_stake_extrinsic> "Link to this definition")
...
bittensor.core.extrinsics.move_stake.swap_stake_extrinsic(_subtensor_ , _wallet_ , _hotkey_ss58_ , _origin_netuid_ , _destination_netuid_ , _amount_ , _safe_swapping =False_, _allow_partial_stake =False_, _rate_tolerance =0.005_, _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =True_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.move_stake.swap_stake_extrinsic> "Link to this definition")
...
Parameters:
  ...
  * **subtensor** ([_bittensor.core.subtensor.Subtensor_](<../../subtensor/index.html#bittensor.core.subtensor.Subtensor> "bittensor.core.subtensor.Subtensor")) – The subtensor instance to interact with the blockchain.
...
[ __ previous bittensor.core.extrinsics.mev_shield ](<../mev_shield/index.html> "previous page") [ next bittensor.core.extrinsics.pallets __](<../pallets/index.html> "next page")
