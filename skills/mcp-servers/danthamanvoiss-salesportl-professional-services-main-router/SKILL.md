---
name: salesportl-professional-services-main-router
description: Route professional services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.
version: 2.0.0
tags: [salesportl, professional-services, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Route professional services tasks to the smallest reliable skill stack with context-first logic, tool-node awareness, and confidence-gated recursion.

## Use when
- You are operating inside `SalesPortl-Professional-Services-Skills-Suite`.
- You need professional services execution quality for consultancies, law/accounting firms, and advisory practices.
...
- specialized legal/accounting engagements

## Standard operating patterns (SOP)
- discovery and scope alignment
- compliance-aware messaging review
- engagement onboarding and review cadence

## SalesPortl platform tooling focus (if available in workspace)
- campaign setup for expertise-led demand gen
- workflow nodes for intake→proposal→onboarding
- pipeline stages for opportunity→engagement
...
- salesportl-professional-services-brand-bootstrap-memory-loop
- salesportl-professional-services-context-intake
- salesportl-professional-services-offer-service-mapper
- salesportl-professional-services-sales-conversion-playbook
- salesportl-professional-services-marketing-growth-planner
- salesportl-professional-services-delivery-operations-planner
- salesportl-professional-services-client-success-expansion
- salesportl-professional-services-skill-handoff-protocol
- salesportl-professional-services-quality-review-orchestrator
