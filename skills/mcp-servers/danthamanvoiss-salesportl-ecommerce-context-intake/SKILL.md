---
name: salesportl-ecommerce-context-intake
description: Collect nuanced ecommerce context across business model, micro-niche, and operating constraints.
version: 2.0.0
tags: [salesportl, ecommerce, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Collect nuanced ecommerce context across business model, micro-niche, and operating constraints.
