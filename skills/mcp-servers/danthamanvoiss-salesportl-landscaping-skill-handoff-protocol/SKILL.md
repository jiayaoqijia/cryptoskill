---
name: salesportl-landscaping-skill-handoff-protocol
description: Standardize inter-skill handoffs for landscaping and lawn care services work with clear assumptions, approvals, and next-node instructions.
version: 2.0.0
tags: [salesportl, landscaping, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Standardize inter-skill handoffs for landscaping and lawn care services work with clear assumptions, approvals, and next-node instructions.
