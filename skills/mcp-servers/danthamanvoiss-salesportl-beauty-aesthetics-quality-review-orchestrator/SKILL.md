---
name: salesportl-beauty-aesthetics-quality-review-orchestrator
description: Run recursive quality checks across beauty and aesthetics services outputs, scoring logic, consistency, thoroughness, and completeness.
version: 2.0.0
tags: [salesportl, beauty-aesthetics, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Run recursive quality checks across beauty and aesthetics services outputs, scoring logic, consistency, thoroughness, and completeness.
