# bittensor.core.extrinsics.start_call &#8212; Bittensor SDK Docs  documentation
...
__
  ...
  * [ __ Show source ](<https://github.com/opentensor/btcli/blob/main/autoapi/bittensor/core/extrinsics/start_call/index.rst?plain=1> "Show source")
  * [ __ Open issue ](<https://github.com/opentensor/btcli/issues/new?title=Issue%20on%20page%20%2Fautoapi/bittensor/core/extrinsics/start_call/index.html&body=Your%20issue%20content%20here.> "Open an issue")



__

  * [ __ .rst ](<../../../../../_sources/autoapi/bittensor/core/extrinsics/start_call/index.rst> "Download source file")
  * __ .pdf
...
##  Contents 
  ...
  * [Module Contents](<#module-contents>)
    * [`start_call_extrinsic()`](<#bittensor.core.extrinsics.start_call.start_call_extrinsic>)



# bittensor.core.extrinsics.start_call[#](<#module-bittensor.core.extrinsics.start_call> "Link to this heading")

## Functions[#](<#functions> "Link to this heading")

[`start_call_extrinsic`](<#bittensor.core.extrinsics.start_call.start_call_extrinsic> "bittensor.core.extrinsics.start_call.start_call_extrinsic")(subtensor, wallet, netuid, *[, ...]) | Submits a start_call extrinsic to the blockchain, to trigger the start call process for a subnet (used to start a  
---|---  
  
## Module Contents[#](<#module-contents> "Link to this heading")

bittensor.core.extrinsics.start_call.start_call_extrinsic(_subtensor_ , _wallet_ , _netuid_ , _*_ , _mev_protection =DEFAULT_MEV_PROTECTION_, _period =None_, _raise_error =False_, _wait_for_inclusion =True_, _wait_for_finalization =False_, _wait_for_revealed_execution =True_)[#](<#bittensor.core.extrinsics.start_call.start_call_extrinsic> "Link to this definition")
...
[ __ previous bittensor.core.extrinsics.staking ](<../staking/index.html> "previous page") [ next bittensor.core.extrinsics.sudo __](<../sudo/index.html> "next page")
