---
name: salesportl-painting-marketing-growth-planner
description: Plan measurable painting services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
version: 2.0.0
tags: [salesportl, painting, niche-suite, context-loop, qa-recursive, tool-node-aware]
---

## Purpose
Plan measurable painting services growth programs using SalesPortl campaigns, click tracking, and workflow nodes.
